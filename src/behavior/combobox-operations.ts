...
export function autocompleteComboboxView(
  ...
  switch (transition.kind) {
    ...
    default: {
      ...
      const interactionTransition = transition.kind === 'pageActive'
        ...
        : transition;
      const nextInteraction = collectionInteractionReducer(interaction, interactionTransition, {
        index: options.index,
...
function withInitialActive(
  interaction: ComboboxState['interaction'],
  options: ComboboxReducerOptions,
): ComboboxState['interaction'] {
