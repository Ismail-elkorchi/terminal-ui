...
type MenuRow = MenuItemModel & { readonly depth: number };

interface MenuContentModel {
...
function publicMenuView(value: MenuContentModel): MenuView {
  return {
...
function flattenMenu(items: readonly MenuItemModel[], depth = 0): readonly MenuRow[] {
...
function decodeInlineContent(value: InlineContent, subject: string): InlineContent {
  try {
...
function decodePlacement(value: AnchoredSurfacePlacement | undefined): AnchoredSurfacePlacement {
