...
export interface TableCustomColumn<TRow = unknown> extends TableColumnBase<TRow> {
  readonly renderCell: (
    row: TRow,
    rowIndex: number,
    columnIndex: number
...
export type TableColumn<TRow = unknown> = TableValueColumn<TRow> | TableCustomColumn<TRow>;
...
export function tableColumn<TRow, TValue>(
  definition?: TableColumnDefinition<TRow, TValue>
): TableCustomColumn<TRow> | TableColumnBuilder<TRow> {
