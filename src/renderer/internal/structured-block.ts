...
function headerLine(
  ...
  if (block.result !== undefined) {
    spans.push(
      ...
      documentSpan(options.renderNode, options.kind, 'chrome', 'result.open', '[', documentResultStyle(block.result), sourceOptionsForBlock(options)),
      documentSpan(options.renderNode, options.kind, 'result', `result.${sourceToken(block.result)}`, block.result, documentResultStyle(block.result), sourceOptionsForBlock(options)),
      documentSpan(options.renderNode, options.kind, 'chrome', 'result.close', ']', documentResultStyle(block.result), sourceOptionsForBlock(options))
    );
  }
  if (block.level !== undefined) {
    spans.push(
      ...
      documentSpan(options.renderNode, options.kind, 'chrome', 'level.open', '[', documentRecordLevelStyle(block.level), sourceOptionsForBlock(options)),
      documentSpan(options.renderNode, options.kind, 'level', `level.${sourceToken(block.level)}`, block.level, documentRecordLevelStyle(block.level), sourceOptionsForBlock(options)),
      documentSpan(options.renderNode, options.kind, 'chrome', 'level.close', ']', documentRecordLevelStyle(block.level), sourceOptionsForBlock(options))
    );
  }
  spans.push(
