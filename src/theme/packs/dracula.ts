...
export const draculaThemeDefinition = themePackDefinition('dracula', {
  ...
  'surface.chrome.background': rgb(40, 42, 54),
  'surface.chrome.border': rgb(98, 114, 164),
  'surface.raised.background': rgb(40, 42, 54),
  'surface.raised.border': rgb(139, 233, 253),
  'surface.inset.background': rgb(25, 26, 34),
  'surface.inset.border': rgb(68, 71, 90),
  'surface.selected.background': rgb(68, 71, 90),
  'surface.selected.border': rgb(189, 147, 249),
  'surface.warning.background': rgb(55, 53, 39),
  'surface.warning.border': rgb(241, 250, 140),
  'surface.danger.background': rgb(58, 37, 45),
  'surface.danger.border': rgb(255, 85, 85),
  'surface.success.background': rgb(34, 53, 42),
  'surface.success.border': rgb(80, 250, 123),
  'surface.shadow': rgb(68, 71, 90),
