...
export function adoptCalendarDate(value: unknown, subject = 'calendar date'): CalendarDate {
...
export type CalendarTransition = Exclude<CalendarAction, { readonly kind: 'setActive' }>;
