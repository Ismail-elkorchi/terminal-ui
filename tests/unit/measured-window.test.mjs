...
test('measuredWindow projects terminal rows rather than item counts', () => {
...
test('measuredWindow reveals a selected item and anchors oversized items at their start', () => {
...
test('measuredWindow rejects duplicate identities', () => {
  assert.throws(() => measuredWindow({
    items: [items[0], { id: 'one', value: 'duplicate', rows: 1 }],
    viewportRows: 2
