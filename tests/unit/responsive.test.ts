...
void test('responsive selects explicit viewport variants deterministically', () => {
...
void test('responsive rejects breakpoint overlap and uncovered viewports unless default exists', () => {
...
void test('responsive rejects missing runtime variant functions clearly', () => {
  const breakpoints = defineBreakpoints({
