...
test('invalid run configuration is rejected before terminal mutation', async () => {
...
test('cleanup clock failure is diagnostic data and does not suppress restoration', async () => {
  const host = createMemoryTerminalHost();
  host.input('\r');
