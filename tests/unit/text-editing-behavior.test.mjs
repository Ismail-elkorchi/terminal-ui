...
test('textInputReducer applies edits and grapheme-aware pointer selections', () => {
...
test('textAreaReducer owns editing selection and normalized scroll in one action channel', () => {
  const initial = {
    input: { text: 'alpha\nbeta', cursor: 0 },
